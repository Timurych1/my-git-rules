...
- `git reset --hard <commit>` - переместить текущую ветку на `<commit>`, задать индекс и директорию согласно коммиту, устраняя изменения
- `git reset --mixed <commit>` - переместить текущую ветку на `<commit>`, задать индекс согласно коммиту, оставить разницу между коммитами в рабочей директории
- `git reset --soft <commit>` - переместить текущую ветку на `<commit>`, не задавать индекс и директорию согласно коммиту, а оставить разницу между коммитами в индексе и рабочей директории
